...
quest_item_dialog: Dict[int, Dict[int, List[int]]] = {
    0x1010: {standard_location_name_to_id["Well H20 - Grillin Village"]: [0x1c3110, 0x1c2eb4],
    standard_location_name_to_id["Agree to Fix Steamwood - Grillin Village"]: [0x1f066c, 0x1f00d4]},
    #standard_location_name_to_id["Mayor Berry - Grillin Village"]: [0x1f0788, 0x1f0198]},
    0x3022: {standard_location_name_to_id["Jon's Key - Graveyard"]: [0x182d24, 0x182ef8]},
    0x3029: {standard_location_name_to_id["First Log - Twinpeak Second Peak"]: [0x19298c, 0x192a5c],
    standard_location_name_to_id["Second Log - Twinpeak Second Peak"]: [0x192a18, 0x192adc],
    standard_location_name_to_id["Third Log - Twinpeak Second Peak"]: [0x192a50, 0x192b0c],
    standard_location_name_to_id["Fourth Log - Twinpeak Second Peak"]: [0x192a84, 0x192b3c],
    standard_location_name_to_id["Aqualin - Twinpeak Second Peak"]: [0x192bd8, 0x192c74]},
    0x1052: {standard_location_name_to_id["Key from Wid - Grillin Village"]: [0x19149c, 0x191354],
    standard_location_name_to_id["Defeat Vambee Soldiers - Grillin Village"]: [0x1930b0, 0x192814],
    standard_location_name_to_id["Return Bell - Grillin Village"]: [0x1926a4, 0x192078]},
    0x2057: {standard_location_name_to_id["Rescue Tim - Grillin Village"]: [0x1e3e34, 0x1e3908]},
    0x3047: {standard_location_name_to_id["Misteria - Misteria Underground Lake"]: [0x188c84, 0x188e58]},
    0x3034: {standard_location_name_to_id["Ugly Belt - Restaurant Basement"]: [0x18a004, 0x189f2c]},
    0x1077: {standard_location_name_to_id["Mrs Govern's Pie - Grillin Village"]: [0x1e108c, 0x1e0e28],
    standard_location_name_to_id["Reward #1 After Extinguishing Village - Grillin Village"]: [0x1e1d5c, 0x1e1798],
    standard_location_name_to_id["Reward #2 After Extinguishing Village - Grillin Village"]: [0x1e1f54, 0x1e18d8]},
    0x304b: {standard_location_name_to_id["Gondola Gizmo 1 - Scrap Depository"]: [0x184360, 0x184424]},
    #0x: {standard_location_name_to_id["Gondola Gizmo 2 - Scrap Depository"]: [0x184450, 0x1844ec]},
    #0x: {standard_location_name_to_id["Gondola Gizmo 3 - Scrap Depository"]: [0x184450, 0x1844ec]},
    #0x: {standard_location_name_to_id["Gondola Gizmo 4 - Scrap Depository"]: [0x184450, 0x1844ec]},
    0x301e: {standard_location_name_to_id["Handle #0 - Steamwood 2"]: [0x1867ac, 0x186740]},
    0x3020: {standard_location_name_to_id["Handle #1 - Steamwood 2"]: [0x19bf90, 0x19c0d4],
    standard_location_name_to_id["Profits - Steamwood 2"]: [0x19c56c, 0x19c60c]},
    #0x: {standard_location_name_to_id["Handle #4 - Steamwood 2"]: [0x19bf90, 0x19c0d4]},
    #0x: {standard_location_name_to_id["Handle #8 - Steamwood 2"]: [0x19bf90, 0x19c0d4]},
    0x1094: {standard_location_name_to_id["Accept or Reject Profits - Grillin Village"]: [0x1e7a40, 0x1e75c4]},
    0x3014: {standard_location_name_to_id["Jon's Note - Somnolent Forest Deadend"]: [0x191758, 0x1917a4]},
}
