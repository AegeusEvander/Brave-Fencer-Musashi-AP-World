...
item_table: Dict[str, BFMItemData] = {
    ...
    "Misteria": BFMItemData(IC.progression, 1, 0x56, "Quest", jp_name = "まばろしのはな"),
    "Aqualin": BFMItemData(IC.progression, 1, 0x2 + quest_base_id, "Quest", jp_name = "いやしのみず"),
    "Rope": BFMItemData(IC.progression, 1, 0x58, "Quest", jp_name = "かぎづめロープ"),
    "Key": BFMItemData(IC.progression, 1, 0x59, "Quest", jp_name = "はいこうのカギ"),
    "Angel Statue": BFMItemData(IC.progression, 1, 0x5a, "Quest", jp_name = "てんしのぞう"),
    "Handle #0": BFMItemData(IC.progression, 1, 0x67, "Quest", jp_name = "0ばんハンドル"),
    "Handle #1": BFMItemData(IC.progression, 1, 0x5b, "Quest", jp_name = "1ばんハンドル"),
    "Handle #4": BFMItemData(IC.progression, 1, 0x5c, "Quest", jp_name = "4ばんハンドル"),
    "Handle #8": BFMItemData(IC.progression, 1, 0x5d, "Quest", jp_name = "8ばんハンドル"),
    "Calendar": BFMItemData(IC.filler, 1, 0x5e, "Quest", jp_name = "カレンダー"),
    "Rock Salt": BFMItemData(IC.progression, 1, 0x5f, "Quest", jp_name = "あらじお"),
    "Gondola Gizmo?": BFMItemData(IC.filler, 1, 0x63, "Quest", jp_name = "ゴンドラパーツ?"),
    "Gondola Gizmo": BFMItemData(IC.progression, 1, 0x64, "Quest", jp_name = "ゴンドラパーツ"),
    "Gondola Gizmo??": BFMItemData(IC.filler, 1, 0x65, "Quest", jp_name = "ゴンドラパーツ??"),
